...
def render_header(decision: str = "HOLD"):
    ...
    if "BUY" in decision:
        ...
        accent_emoji = "🟢"
        animal_svg = """
        <svg width="38" height="38" viewBox="0 0 38 38" style="vertical-align:middle;">
            <text x="0" y="30" font-size="32" font-family="Segoe UI Emoji">🐂</text>
        </svg>
        """
    elif "SELL" in decision:
        grad = "linear-gradient(270deg, #fa709a 0%, #fee140 100%)"
