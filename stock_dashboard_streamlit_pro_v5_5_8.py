            ...
            <div style="position:relative;z-index:1;">
                <div style="display:flex;align-items:center;justify-content:space-between;">
                    <div style="display:flex;align-items:center;gap:20px;">
                        ...
                        <div>
                            <div style="font-size:28px;font-weight:900;letter-spacing:0.5px;">
                                <span style="background: linear-gradient(90deg,#1976d2,#43e97b); -webkit-background-clip: text; -webkit-text-fill-color: transparent; display:inline-block; font-family:monospace;">
                                    <span style="font-size:1.1em;">AI</span><span style="color:#43e97b;">Σ</span>igma<span style="color:#8e24aa;">X</span>
                                </span>
                                <span style="font-size:18px;opacity:0.85;font-weight:600;">AI Stock Signals</span>
                            </div>
                            <div style="font-size:15px;opacity:0.93;">
                            ...
                            <div style="font-size:15px;opacity:0.93;margin-top:7px;">
                                👋 <b>Welcome to <span style="font-family:monospace;">AI<span style="color:#43e97b;">Σ</span>igma<span style="color:#8e24aa;">X</span></span></b> — Start by entering a stock symbol below.<br>
                                <span style="font-size:14px;opacity:0.85;">(e.g. <code>AAPL</code>, <code>MSFT</code>, <code>NVDA</code>, <code>TSLA</code>)</span>
                            </div>
                        </div>
                    </div>
