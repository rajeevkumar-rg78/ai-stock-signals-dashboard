...
st.markdown("""
<div style="
    background: linear-gradient(90deg, #3A0CA3 0%, #7209B7 40%, #B5179E 100%);
    color: white;
    text-align: left;
    padding: 26px 28px;
    border-radius: 16px;
...
">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between;">
        ...
        <div style="display:flex; align-items:center; gap:18px;">
            ...
            <div>
                ...
                <div style="font-size:15px; opacity:0.92;">
                    Start by reading this quick guide before exploring your first stock.
                </div>
            </div>
        ...
        <div style="text-align:right; font-size:14px; opacity:0.96;">
