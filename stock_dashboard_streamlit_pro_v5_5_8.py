...
def render_header(decision: str = "HOLD"):
    ...
    st.markdown(
        ...
        <div class="aisx-banner">
            <div class="aisx-flex">

                <!-- Left section -->
                <div>
                    <div class="aisx-title">AISigmaX</div>
                    <div class="aisx-tagline">Next-Gen AI • Macro • News • Analyst • Forecasts</div>
                </div>

                <!-- Right section -->
                <div class="aisx-right">
